...
for dataset in ["Caravaggio2", "Caravaggio1", "Raphael", "Rubens"]:
  # Read meta file
  relative_path = ''
  ...
  df_rot_index = df_angles_rot.apply(
    lambda x: f(x['8ad1caa8-fefe-42b0-b527-6de26daa60a5_d8bbaaa1-dde0-4324-a906-adb382e9ef90']), axis=1)
  # print(df_rot_index)
  ...
  angle_torso = df_angles_rot.apply(
    lambda x: f2(x['8ad1caa8-fefe-42b0-b527-6de26daa60a5_d8bbaaa1-dde0-4324-a906-adb382e9ef90']), axis=1)
  ...
  df_angles_rot[
    'rotated'] = df_rot_index  # df_rot_index = 0 (if no rotation happened i.e. if we have no torso, 1 otherwise)
  ...
  df_angles_rot_sin_cos['rotation_sin'] = np.sin(np.radians(rotation))
  df_angles_rot_sin_cos['rotation_cos'] = np.cos(np.radians(rotation))
